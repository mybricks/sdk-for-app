...
const API_DOMAIN_SERVICE = "https://my.mybricks.world/runtime/api/domain/service/run";
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            ...
            content: [
                {
                    answer: "您好，我是Mybricks智能QA小助手，请问有什么问题可以帮您解答吗？",
                },
            ],
        },
    ]);
                ...
                <div className={css.dialog}>
                    ...
                    <div className={css.inputContainer}>
                        <Input
                            ...
                            placeholder="请输入您的问题"
                            value={question}
                            onChange={(ctx) => setQuestion(ctx.target.value)}
                            onPressEnter={send}
                        ></Input>
